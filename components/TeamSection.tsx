  ...
  const team = [
    {
      ...
      links: [
        { labelKey: 'team.social.linkedin', icon: 'linkedin', url: "https://www.linkedin.com/in/marcelo-m7/" },
        { labelKey: 'team.social.github', icon: 'github', url: "https://github.com/marcelo-m7" }
      ]
    },
    {
      id: 'tercio',
      ...
      links: [
        { labelKey: 'team.social.linkedin', icon: 'linkedin', url: "https://www.linkedin.com/in/t%C3%A9rcio-barreto-40a840120/" }
      ]
    }
  ];
    ...
    <section className="bg-brand-black py-32 px-6 border-b-4 border-white">
      <div className="max-w-[1600px] mx-auto">
        <div className="flex flex-col mb-24">
          <span className="text-xs font-black tracking-[0.5em] uppercase text-brand-violet mb-6">{t('team.label')}</span>
          <h2 className="text-6xl md:text-8xl font-black tracking-tighter uppercase font-display">{t('team.headingLine1')} <br />{t('team.headingLine2')}</h2>
        </div>
            ...
            >
              ...
              <div className="flex flex-col justify-between h-full flex-grow">
                <div>
                  ...
                  <p className="text-xs font-black tracking-widest uppercase text-brand-violet mb-8 group-hover:text-white transition-colors">{t(`team.members.${member.id}.role`)}</p>
                  <p className="text-xl text-slate-400 group-hover:text-black/80 mb-12 leading-relaxed transition-colors">{t(`team.members.${member.id}.bio`)}</p>
                </div>
                ...
                <div className="flex flex-wrap gap-6 mt-auto">
                  {member.links.map(link => (
                    ...
                    >
                      ...
                      <span className="underline underline-offset-8">{t(link.labelKey)}</span>
                    </a>
                  ))}
                </div>
              </div>
