...
export const Services: React.FC<ServicesProps> = ({ onNavigate }) => {
  ...
  const odooTags = t('services.odoo.tags', { returnObjects: true }) as string[];
        ...
        <div className="grid lg:grid-cols-12 min-h-screen">
          ...
          <div className="lg:col-span-11 p-8 md:p-24 flex flex-col justify-center">
            <motion.div
              ...
              className="mb-12"
            >
              <h3 className="text-5xl md:text-9xl font-black tracking-tighter leading-none mb-4 opacity-10 uppercase font-display">{t('services.odoo.word1')}</h3>
              <h3 className="text-5xl md:text-9xl font-black tracking-tighter leading-none mb-4 opacity-30 uppercase font-display">{t('services.odoo.word2')}</h3>
              <h3 className="text-5xl md:text-9xl font-black tracking-tighter leading-none uppercase font-display">{t('services.odoo.word3')}</h3>
            </motion.div>

            <div className="max-w-4xl">
              <h2 className="text-6xl md:text-8xl font-black mb-10 tracking-tighter uppercase text-brand-blue font-display">Odoo <br />{t('services.odoo.heading')}</h2>
        ...
        <div className="grid lg:grid-cols-12 min-h-[90vh]">
          ...
          <div className="lg:col-span-11 p-8 md:p-24 flex flex-col justify-center">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <span className="text-black text-xs font-black tracking-[0.4em] uppercase mb-8 inline-block">{t('services.software.badge')}</span>
              <h2 className="text-6xl md:text-[10rem] font-black tracking-tighter leading-[0.8] mb-12 uppercase font-display">{t('services.software.headingLine1')} <br />{t('services.software.headingLine2')}</h2>
              ...
              <div className="grid lg:grid-cols-2 gap-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="p-8 border-4 border-black bg-white text-black hover:-translate-y-2 transition-transform">
                    ...
                    <h4 className="text-xl font-black uppercase mb-2 font-display">{t('services.software.internalToolsTitle')}</h4>
                    <p className="text-xs font-bold uppercase text-black/60">{t('services.software.internalToolsDescription')}</p>
                  </div>
                  <div className="p-8 border-4 border-black bg-white text-black hover:-translate-y-2 transition-transform">
                    <div className="w-12 h-12 bg-black text-white flex items-center justify-center mb-6">
                    ...
                    <h4 className="text-xl font-black uppercase mb-2 font-display">{t('services.software.platformsTitle')}</h4>
                    <p className="text-xs font-bold uppercase text-black/60">{t('services.software.platformsDescription')}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-20">
                ...
                >
                  ...
                  <span className="text-xl font-black tracking-widest uppercase font-display underline underline-offset-8">{t('services.software.viewPartnerships')}</span>
                </button>
              </div>
            </motion.div>
          </div>
